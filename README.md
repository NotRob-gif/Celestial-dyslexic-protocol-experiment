...
5. Build the project using the x64 configuration.
6. Run the program.
...
1. Calculate the ratio between the two distances.
2. Multiply the ratio by 1,000,000.
3. Multiply that value by the primary planet distance.
4. Reduce the result into a manageable numeric range.
5. XOR the result with messageNum.
